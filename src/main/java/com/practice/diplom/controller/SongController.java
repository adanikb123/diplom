...
public class SongController {
    ...
    public SongResponseDto createSong(@RequestBody SongRequestDto songResponseDto){
    ...
    public UserSongResponseDto createUserSong(@RequestBody UserSongRequestDto userSongRequestDto){
